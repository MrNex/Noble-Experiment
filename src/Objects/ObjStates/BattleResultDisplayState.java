 ...
 *
 */
public class BattleResultDisplayState extends ObjState{
	...
	private Font headingFont = new Font("Serif", Font.BOLD, 48);
	private Font statsFont = new Font("Serif", Font.PLAIN, 24);
	 ...
	 * Writes content to all strings based on battle
	 */
	public BattleResultDisplayState(boolean playerWon) {
		super();
		
		//Write heading
		if(playerWon) heading = "Victory!";
		else heading = "Defeat!";
