 ...
 *
 */
public class TargetEquationDisplayState extends ObjectState {
	...
	/**
	 * Initializes all internal member variales
	 */
	@Override
	protected void init() {
		fontSize = 50;
	...
	public void draw(Graphics2D g2d) {
		...
		g2d.drawString(displayString, 
				...
				(int)(attachedTo.getYPos() + attachedTo.getHeight() / 2.0 + stringHeight / 2.0));
